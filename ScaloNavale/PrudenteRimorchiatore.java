...
public class PrudenteRimorchiatore implements RimorchiatoreI {
    ...
    /*
     * AF: navi rappresenta le navi portate in un singolo momento da un pridenterimorchiatore, pesoMax è il carico massimo in grado di spostare 
     *  (oltre alla prima nave cargo ), 
     * la somma delle navi spostate in ciascun viaggio non eccede il carico massimo
     * 
     * IR: navi deve essere != da null, può contenere null ma solo se seguiti da altri null e non da dei Cargo,
    ...
    //MODIFIES: a, b
    //EFFECTS: questo metodo sposta n navi insieme dal molo a al molo b, solleva un eccezione se a o b sono nulli, 
    //          se ----------- ------------------SISTEMA
    //          restituisce true se 
    ...
    /*
     * EFFECTS: restituisce il massimo peso che può portare un rimorchiatore prudente
     */
